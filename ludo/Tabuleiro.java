...
public class Tabuleiro extends JFrame{
  ...
  //TitledBorder titledBorder1;
  public Tabuleiro() {
    super("Ludo Java 1.0<<<<<<<Por Thiago e Helton>>>>>>>>");
  ...
  private void jbInit() throws Exception {
    ...
    jLabelTabuleiro.setIcon(new ImageIcon(Tabuleiro.class.getResource("tabuleiro.gif")));
  ...
  private void alteraTextFieldJogador(Jogador j){ //metodo para alterar o textfield do jogador atual!
   ...
   public void alteraDado(){
     ...
     switch(jogo.getDadoFace()){
       case 1:
         jLabelDado.setIcon(new ImageIcon(Tabuleiro.class.getResource("n1.gif")));
         break;
       case 2:
         jLabelDado.setIcon(new ImageIcon(Tabuleiro.class.getResource("n2.gif")));
         break;
       case 3:
         jLabelDado.setIcon(new ImageIcon(Tabuleiro.class.getResource("n3.gif")));
         break;
       case 4:
         jLabelDado.setIcon(new ImageIcon(Tabuleiro.class.getResource("n4.gif")));
         break;
       case 5:
         jLabelDado.setIcon(new ImageIcon(Tabuleiro.class.getResource("n5.gif")));
         break;
       case 6:
         jLabelDado.setIcon(new ImageIcon(Tabuleiro.class.getResource("n6.gif")));
         break;
     }
     //if(!(jogo.getJogadorAtual() instanceof Computador))
         //tocaSoms.playAudioJogaDNovo();
